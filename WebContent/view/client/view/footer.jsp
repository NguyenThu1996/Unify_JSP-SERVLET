			...
			<div class="row">
				...
				<div class="col-md-4 md-margin-bottom-40">
					...
					<ul class="list-unstyled address-list margin-bottom-20">
						...
						<li><i class="fa fa-angle-right"></i>Phone: 0988.234.076</li>
						<li><i class="fa fa-angle-right"></i>Hotline: 01299 725 789</li>
						<li><i class="fa fa-angle-right"></i>Email: thu.n.v@zenkenplanet-vn.com
							</li>
					</ul>

					<ul class="list-inline shop-social">
						<li><a href="https://www.facebook.com/profile.php?id=100007462455263"><i class="fb rounded-md fa fa-facebook"></i></a></li>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<p>
						2020 &copy; Development by Nguyen_Thu_BKDN <a target="_blank"
							href="https://www.facebook.com/profile.php?id=100007462455263">Htmlstream</a> | <a
